    ...
    try {
        ...
        if (!s_id) {
            ...
            return;
             ...
             const response = await fetch(`http://localhost:8080/api/complaint/unassigned/${s_id}`);
                ...
                if (complains.length === 0) {
                    ...
                    <p>Reported         : ${new Date(complaint.postedAt).toLocaleString()}</p>
                        ...
                        updateButton.addEventListener("click", () => {
                            ...
                            fetch(`http://localhost:8080/api/complaint/update/assigned/${complaint.complaint_id}`, {
                                method: "POST",
                                headers: {
